...
<p align="center">PERGJEGJESIT JANE PARAQITUR SI ME POSHTE : </p><br>
<?php
...
<table style="width:100%">
  ...
  <?php 
  while($pergjegjesit=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$pergjegjesit['peremer']."</td>";
    echo "<td>".$pergjegjesit['permbiemer']."</td>";
    
      echo "<td>".$pergjegjesit['pergjinia']."</td>";
      echo "<td>".$pergjegjesit['permosha']."</td>";
       echo "<td>".$pergjegjesit['peremail']."</td>";
        echo "<td>".$pergjegjesit['perkartebanke']."</td>";
        echo "<td>".$pergjegjesit['perllojikarte']."</td>";
                echo "<td>".$pergjegjesit['perarsim']."</td>";
 echo "<td>".$pergjegjesit['perkontakti']."</td>";
 echo "<td>".$pergjegjesit['perkontrate']."</td>";
echo "<td>".$pergjegjesit['perposti']."</td>";
 echo "<td>".$pergjegjesit['perpaga']."</td>";
    echo "</tr>";
