...
<p align="center">SHEFAT E KUZHINES JANE PARAQITUR SI ME POSHTE : </p><br>
<?php
...
<table style="width:100%">
  ...
  <?php 
  while($shefkuzhine=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$shefkuzhine['emershefi']."</td>";
    echo "<td>".$shefkuzhine['mbiemershefi']."</td>";
      echo "<td>".$shefkuzhine['gjiniashefi']."</td>";
      echo "<td>".$shefkuzhine['moshashefi']."</td>";
       echo "<td>".$shefkuzhine['emailshefi']."</td>";
        echo "<td>".$shefkuzhine['kartashefi']."</td>";
        echo "<td>".$shefkuzhine['kartatipshefi']."</td>";
                echo "<td>".$shefkuzhine['arsimshef']."</td>";
 echo "<td>".$shefkuzhine['telshef']."</td>";
 echo "<td>".$shefkuzhine['shefkontrate']."</td>";
echo "<td>".$shefkuzhine['shefpoz']."</td>";
  echo "<td>".$shefkuzhine['pagashefi']."</td>";
    echo "</tr>";
