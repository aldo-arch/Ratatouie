...
</div><br><p align="center">MIRESEVINI NE RATATOUIE !!!</p><BR>
<p align="center"> Emri : <?php echo $_SESSION['name']; ?> </p><br>
<p align="center"> Mbiemri : <?php echo $_SESSION['surname']; ?> </p><br>
<p align="center"> Gjinia : <?php echo $_SESSION['gender']; ?> </p><br>
<p align="center"> Mosha : <?php echo $_SESSION['age']; ?> </p><br>
<p align="center"> E-Mail : <?php echo $_SESSION['email']; ?> </p><br>
<p align="center"> Karta Bankare : <?php echo $_SESSION['creditcard']; ?> </p><br>
<p align="center"> Lloji : <?php echo $_SESSION['type']; ?> </p><br>
<p align="center"> Nr.Kontakti : <?php echo $_SESSION['contact']; ?> </p><br>
<br>
<form action="profil1.php" method="get">
<p align="center"><a href=logout.php class="button1"> DILNI </a></p><br>
<p align="center"> <input type="submit" value="Ndrysho" 
         name="Submit" id="frm1_submit" class="button1"/></p><br>
</form>
	<div class="body3">
  <div class="body4">
    <div class="main">
