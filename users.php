...
<div class="body6">
  ...
  <!-- / header -->
      <!-- permbajtje -->
        ...
        <br>
        <p align="center">KETU ADMINISTRATORET VESHTROJNE ELEMENTIN USER PERKATESISHT PER :</p>
         <div class="body6">
  <div class="body1">
    <div class="body5">
      <div class="main"><div class="wrap">
            <section class="cols">
              <div class="box">
                <div>
                  <h2><span>Perdoruesit!</span></h2>
                  <figure><img src="images/us.jpg" alt=""></figure>
                  <p class="pad_bot1">Veshtro perdoruesit me te dhenat perkatese duke klikuar butonin users !!!</p>
                  <a href="listeuser.php" class="button1">Users!!!</a> </div>
              </div>
            </section>
            <section class="cols pad_left1">
              <div class="box">
                <div>
                  <h2><span>Porosite!</span></h2>
                  <figure><img src="images/or.jpg" alt=""></figure>
                  <p class="pad_bot1">Veshtro porosite qe perdoruesit kane kryer online duke klikuar butonin orders !!!</p>
                  <a href="ordering.php" class="button1">Orders!!!</a> </div>
              </div>
            </section>
            <section class="cols pad_left1">
              <div class="box">
                <div>
                  <h2><span>Pershtypja!</span></h2>
                  <figure><img src="images/op.png" alt=""></figure>
    <p class="pad_bot1">Veshtro pershtypjet qe perdoruesit kane online duke klikuar butonin opinions !!!</p>
                  <a href="opinionet.php" class="button1">Opinions!!!</a> </div>
              </div>
            </section>
          </div>
        </article>
