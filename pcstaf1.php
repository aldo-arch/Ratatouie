...
<p align="center">STAFI JUAJ IT ESHTE PARAQITUR SI ME POSHTE : </p><br>
<?php
...
<table style="width:100%">
  ...
  <?php 
  while($StafiIT=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$StafiIT['workername']."</td>";
    echo "<td>".$StafiIT['workersurname']."</td>";
     echo "<td>".$StafiIT['workergender']."</td>";
      echo "<td>".$StafiIT['workerage']."</td>";
      echo "<td>".$StafiIT['workeremail']."</td>";
       echo "<td>".$StafiIT['workercreditcard']."</td>";
        echo "<td>".$StafiIT['workercdtype']."</td>";
        echo "<td>".$StafiIT['workereducation']."</td>";
                echo "<td>".$StafiIT['workercontactnum']."</td>";
 echo "<td>".$StafiIT['kontrata']."</td>";
 echo "<td>".$StafiIT['workerrole']."</td>";
echo "<td>".$StafiIT['workerwage']."</td>";
    echo "</tr>";
