...
<p align="center">EVENTET JANE PARAQITUR SI ME POSHTE : </p><br>
<?php
...
<table style="width:100%">
  <tr>
    ...
    <th>ORA</th>
    <th>MINUTI</th>
    <th>KAPACITETI PER PERSONA</th>
    <th>TE FTUAR SPECIALE</th>
  </tr>
  <?php 
  while($Events=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$Events['evname']."</td>";
    echo "<td>".$Events['evday']."</td>";
     echo "<td>".$Events['evdatnum']."</td>";
      echo "<td>".$Events['evmonth']."</td>";
      echo "<td>".$Events['evyear']."</td>";
       echo "<td>".$Events['evhr']."</td>";
        echo "<td>".$Events['evmin']."</td>";
        echo "<td>".$Events['evcapacity']."</td>";
                echo "<td>".$Events['evspecialg']."</td>";
