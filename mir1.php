...
<p align="center">REGJISTRO MIREMBAJTESIN E RI NE STAFIN E RATATOUIE !</p>
<form action="mir3.php" method="post">
  <h1>EMER:</h1>
  ...
  <h1>NR.KONTAKTI:</h1>
  <input type="number" min="0" max="999999999999999" name="nrkontakti" maxlength="15" required><br>
  <h1>KONTRATE</h1>
  ...
  <p align=center><button type="submit" name="submit" class="button1">Shto mirembajtesin !</button></p>
  </form>
 <div class="body3">
  <div class="body4">
    <div class="main">
