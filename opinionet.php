...
<p align="center">KETU MUND TE VESHTRONI OPINIONET NGA PERDORUESIT PERKATES : </p>
<p align="center">PER TA AFISHUAR PERSHTYPJEN E ZGJEDHUR (ME ID PERKATESE) NE FAQEN E PARE KONTAKTONI ME STAFIN IT</p><br>
<?php
...
$sql=("SELECT *  FROM Pershtypje");
$records=mysql_query($sql);
?>
<table style="width:100%">
  <tr>
    <th>ID E PERSHTYPJES</th>
    <th>EMER I PERDORUESIT</th> 
    <th>PERSHTYPJA</th>
  </tr>
  <?php 
  while($Pershtypje=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$Pershtypje['PershtypjeID']."</td>";
    echo "<td>".$Pershtypje['Username']."</td>";
     echo "<td>".$Pershtypje['opinion']."</td>";
    echo "</tr>";
