...
<p align="center">PERDORUESIT AKTUALE NE RATATOUIE ME TE DHENAT E TYRE PERKATESE JANE : </p><br>
<?php
     ...
     echo "<td>".$users['username']."</td>";
      ...
      echo "<td>".$users['age']."</td>";
       echo "<td>".$users['email']."</td>";
        echo "<td>".$users['creditcard']."</td>";
        echo "<td>".$users['type']."</td>";
                echo "<td>".$users['password']."</td>";
 echo "<td>".$users['contact']."</td>";
    echo "</tr>";
