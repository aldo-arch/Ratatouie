...
<p align="center">REGJISTRO ELEMENTIN E RI NE STAFIN E IT !</p>
<form action="komp.php" method="post">
  <h1>EMER:</h1>
  ...
  <p align=center><button type="submit" name="submit" class="button1">Shto ne staf IT !</button></p>
  </form>
 <div class="body3">
  <div class="body4">
    <div class="main">
