...
<p align="center">MIREMBAJTESIT JANE PARAQITUR SI ME POSHTE : </p><br>
<?php
...
<table style="width:100%">
  ...
  <?php 
  while($mirembajtje=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$mirembajtje['memer']."</td>";
    echo "<td>".$mirembajtje['mmbiemer']."</td>";
    echo "<td>".$mirembajtje['mgjinia']."</td>";
     echo "<td>".$mirembajtje['mmosha']."</td>";
     echo "<td>".$mirembajtje['memail']."</td>";
      echo "<td>".$mirembajtje['mkartebank']."</td>";
       echo "<td>".$mirembajtje['mkartetype']."</td>";
   echo "<td>".$mirembajtje['marsim']."</td>";
 echo "<td>".$mirembajtje['mkontakt']."</td>";
 echo "<td>".$mirembajtje['mkontrate']."</td>";
echo "<td>".$mirembajtje['mpost']."</td>";
  echo "<td>".$mirembajtje['mpaga']."</td>";
