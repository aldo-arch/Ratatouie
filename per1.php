...
<p align="center">REGJISTRO PERGJEGJESIN E RI NE STAFIN E RATATOUIE !</p>
<form action="per3.php" method="post">
  ...
  <p align=center><button type="submit" name="submit" class="button1">Shto pergjegjesin !</button></p>
  </form>
 <div class="body3">
  <div class="body4">
    <div class="main">
