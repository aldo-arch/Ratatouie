...
<p align="center">STAFI JUAJ I SHERBIMIT ESHTE PARAQITUR SI ME POSHTE : </p><br>
<?php
...
$sql=("SELECT *  FROM stafiisherbimit");
...
<table style="width:100%">
  ...
  <?php 
  while($stafiisherbimit=mysql_fetch_assoc($records)){
    echo "<tr>";
    echo "<td>".$stafiisherbimit['workername']."</td>";
    echo "<td>".$stafiisherbimit['workersurname']."</td>";
     echo "<td>".$stafiisherbimit['workergender']."</td>";
      echo "<td>".$stafiisherbimit['workerage']."</td>";
      echo "<td>".$stafiisherbimit['workeremail']."</td>";
       echo "<td>".$stafiisherbimit['workercrbank']."</td>";
        echo "<td>".$stafiisherbimit['workercrbanktype']."</td>";
        echo "<td>".$stafiisherbimit['workereducation']."</td>";
                echo "<td>".$stafiisherbimit['workercontact']."</td>";
 echo "<td>".$stafiisherbimit['workeragree']."</td>";
 echo "<td>".$stafiisherbimit['workerpost']."</td>";
echo "<td>".$stafiisherbimit['workersalary']."</td>";
    echo "</tr>";
