...
<p align="center">REGJISTRO ELEMENTIN E RI NE STAFIN E SHERBIMIT !</p>
<form action="staf1.php" method="post">
  <h1>EMER:</h1>
  ...
  <p align=center><button type="submit" name="submit" class="button1">Shto ne stafin e sherbimit !</button></p>
  </form>
 <div class="body3">
  <div class="body4">
    <div class="main">
