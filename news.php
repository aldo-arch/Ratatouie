...
<div class="body6">
  ...
  <!-- / header -->
      <!-- permbajtje -->
        ...
        <br><form  action="gonews.php" method="post">
        <p align="center">JEPNI TE REJAT ME TE FUNDIT OSE NJOFTIMET TUAJA</p>
        <p align="center">ATO DO TE AFISHOHEN NE FAQEN RATATOUIE NGA STAFI I IT</p><br>
        <p align="center"> <textarea name="textarea1" cols="100" rows="10" required></textarea></p><br>
        <p align="center">
         <input type=reset class="button1"> <input type="submit" class="button1" name="submit"></p>
        <br>
<div class="body3">
  <div class="body4">
    <div class="main">
