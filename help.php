  ...
  <!-- / header -->
    ...
    <article id="content">
        <div class="wrap">
          <div class="box">
            <div>
              <h2 class="letter_spacing">SHKRUANI <span>PROBLEMIN TUAJ</span></h2>
              <form  action="suporti.php" method="post" id="ContactForm">
             <div class="wrapper"> 
                  </div>
                  <div class="textarea_box"> <span>PROBLEMI:</span>
