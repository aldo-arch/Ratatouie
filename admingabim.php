...
<div class="body6">
  ...
  <!-- / header -->
      <!-- permbajtje -->
        ...
        <br>
        <p align="center">NGA KODI QE VENDOSET REZULTON SE JU NUK JENI ADMINISTRATOR</p>
        <p align="center">PASI KENI VENDOSUR KODIN GABIM !!!</p>
        <p align="center">LARGOHUNI NGA KY SHERBIM !!!</p>
        <p align="center">JU FALEMINDERIT </p>
        <br>
        <div class="body3">
  <div class="body4">
    <div class="main">
